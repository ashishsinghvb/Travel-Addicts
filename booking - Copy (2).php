		...
		<div class="bookingWrapper">
			...
			?>
				...
				<div class="col-sm-5">
					...
					<div class="col-sm-4">
						<div class="price"><span class="sansSerif">₹ </span><?php echo $adults*$rowOutbound["fare"]; ?></div>
						<div class="price"><span class="sansSerif">₹ </span><?php echo $children*$rowOutbound["fare"]; ?></div>
						<div class="price"><span class="sansSerif">₹ </span>250</div>
					</div>	
					...
					<div class="col-sm-4">
						<div class="priceTotal"><span class="sansSerif">₹ </span><?php echo ($adults*$rowOutbound["fare"])+($children*$rowOutbound["fare"])+250; ?></div> <!-- CHANGE -->
					</div>
					...
					<form action="passengers.php" method="POST">
						...
						<?php $totalFare = ($adults*$rowOutbound["fare"])+($children*$rowOutbound["fare"])+250 ?>
						<!-- CHANGE -->
